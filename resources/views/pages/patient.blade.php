...
<div class="col-md-12">
    <div class="card card-primary card-outline card-outline-tabs">
        ...
        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
            <li class="nav-item">
            <button class="btn btn-info" data-bs-target="#exampleModalToggle" data-bs-toggle="modal"> Patient Tested PDF</button>            </li>
            </li>          
        </ul>
        </div>
...
<div class="tab-content" id="custom-tabs-four-tabContent">
    ...
    <div class="card">
      ...
      <div id="printContent">
        <hr>
            <h1 style="color:black;">List Of Patients Tested By TB</h1>
        <hr>
