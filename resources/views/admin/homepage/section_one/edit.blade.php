...
<div class="row">
    ...
    <div class="row">
      {!! Form::model($section_one, ['route' => ['home_section_ones.update', $section_one->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'files' => true ]) !!}
      <div class="col-md-">
          ...
          <div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <div class="row koipayImgGarelly">
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_one->imageOne) }}" alt="{{ $section_one->title }}">
                    <span class="form-group col-md-6 input-image-cont">
                      {{ Form::file('imageOne') }}
                    </span>
                  </div>
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_one->imageTwo) }}" alt="{{ $section_one->title }}">
                    <span class="form-group col-md-6 input-image-cont">
                      {{ Form::file('imageTwo') }}
                    </span>
                  </div>
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_one->imageThree) }}" alt="{{ $section_one->title }}">
                    <span class="form-group col-md-6 input-image-cont">
                      {{ Form::file('imageThree') }}
                    </span>
                  </div>
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_one->imageFour) }}" alt="{{ $section_one->title }}">
                    <span class="form-group col-md-6 input-image-cont">
                      {{ Form::file('imageFour') }}
                    </span>
                  </div>
      ...
      <div class="col-md-4">
          <div class="well">
              <dl class="dl-horizontal">
                  ...
                  <dd>{{ date('M j, Y h:ia', strtotime($section_one->created_at)) }}</dd>
              </dl>
    
              <dl class="dl-horizontal">
                  <dt>Last Updated: Date</dt>
                  <dd>{{ date('M j, Y h:ia', strtotime($section_one->updated_at)) }}</dd>
              </dl>
