...
<div class="row">
    ...
    <div class="row">
      {!! Form::model($section_three, ['route' => ['home_section_threes.update', $section_three->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'files' => true ]) !!}
      <div class="col-md-">
          ...
          <div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <div class="row koipayImgGarelly">
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_three->imageOne) }}" alt="{{ $section_three->title }}">
                    <span class="form-group col-md-6 input-image-cont">
                      {{ Form::file('imageOne') }}
                    </span>
                  </div>
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_three->imageTwo) }}" alt="{{ $section_three->title }}">
                    <span class="form-group col-md-6 input-image-cont">
                      {{ Form::file('imageTwo') }}
                    </span>
                  </div>
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_three->imageThree) }}" alt="{{ $section_three->title }}">
                    <span class="form-group col-md-6 input-image-cont">
      ...
      <div class="col-md-4">
          <div class="well">
              <dl class="dl-horizontal">
                  ...
                  <dd>{{ date('M j, Y h:ia', strtotime($section_three->created_at)) }}</dd>
              </dl>
    
              <dl class="dl-horizontal">
                  <dt>Last Updated: Date</dt>
                  <dd>{{ date('M j, Y h:ia', strtotime($section_three->updated_at)) }}</dd>
              </dl>
