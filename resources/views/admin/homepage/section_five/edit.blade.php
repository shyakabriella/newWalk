      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Section Five</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
<div class="row">
    ...
    <div class="row">
      {!! Form::model($section_five, ['route' => ['home_section_fives.update', $section_five->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'files' => true ]) !!}
      <div class="col-md-">
      ...
      <div class="col-md-4">
          <div class="well">
              <dl class="dl-horizontal">
                  ...
                  <dd>{{ date('M j, Y h:ia', strtotime($section_five->created_at)) }}</dd>
              </dl>
    
              <dl class="dl-horizontal">
                  <dt>Last Updated: Date</dt>
                  <dd>{{ date('M j, Y h:ia', strtotime($section_five->updated_at)) }}</dd>
              </dl>
