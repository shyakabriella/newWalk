...
<div class="row">
    ...
    <div class="row">
      {!! Form::model($section_two, ['route' => ['home_section_twos.update', $section_two->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'files' => true ]) !!}
      <div class="col-md-">
          ...
          <div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <div class="row koipayImgGarelly">
                  <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('img/homepage/'.$section_two->imageOne) }}" alt="{{ $section_two->title }}">
      ...
      <div class="col-md-4">
          <div class="well">
              <dl class="dl-horizontal">
                  ...
                  <dd>{{ date('M j, Y h:ia', strtotime($section_two->created_at)) }}</dd>
              </dl>
    
              <dl class="dl-horizontal">
                  <dt>Last Updated: Date</dt>
                  <dd>{{ date('M j, Y h:ia', strtotime($section_two->updated_at)) }}</dd>
              </dl>
